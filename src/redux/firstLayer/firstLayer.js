...
// const FETCH_MARKET_SUCCESS = 'appBook/books/FETCH_BOOKS_SUCCESS';
// const FETCH_MARKET_FAILURE = 'appBook/books/FETCH_BOOKS_FAILURE';
...
const firstLayerReducer = (state = initialMarket, action) => {
  switch (action.type) {
